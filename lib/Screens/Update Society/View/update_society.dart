                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding:  EdgeInsets.fromLTRB(0,MediaQuery.of(context).size.width*0.02 , 0, 0),                    child: MyButton(
                          width:MediaQuery.of(context).size.width*0.29  ,                      textColor: primaryColor,
                          name: "Update",
